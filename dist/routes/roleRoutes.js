...
router.post("/", new _RoleController.default().createRole);
router.get("/", new _RoleController.default().findAllRoles);
router.put("/:id", _validator.default.updateRole, _isAdmin.default, new _RoleController.default().updateRole);
router.delete("/:id", new _RoleController.default().deleteRole);
router.get("/:id", new _RoleController.default().findOneRole);
var _default = router;
